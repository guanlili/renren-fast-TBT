...
public class Echart2Controller {
    ...
    public Map<String,Object> productTradeVolume(@RequestParam Map<String, Object> params){
        ...
        List<Goods2Entity> goods2Entities = goods2Service.findTotalAmountByProductName(fieldName,pickDateStart,pickDateEnd,userName);
        System.out.println(goods2Entities);
        ...
        //查询商品编码
        List<Integer> x_ProductNum =new ArrayList<>();
        //组装x轴名称
        List<String> x_name =new ArrayList<>();

        for (Goods2Entity goods2Entity : goods2Entities){
            x_ProductName.add(goods2Entity.getProductName());
            y_TotalAmount.add(goods2Entity.getRmbAmount());
            x_ProductNum.add(goods2Entity.getProductNum());
            x_name.add((goods2Entity.getProductNum()+"｜"+goods2Entity.getProductName()));
        }
        map.put("y_TotalAmount",y_TotalAmount);
        map.put("x_ProductName",x_ProductName);
        map.put("x_ProductNum",x_name);

        map.put("code",0);
        System.out.println(y_TotalAmount.size());
        System.out.println(x_ProductName.size());
        System.out.println(x_ProductNum.size());
    ...
    public Map<String,Object> nationalTradeVolume(@RequestParam Map<String, Object> params){
        ...
        List<Goods2Entity> goods2Entities = goods2Service.findTotalAmountByNationalName(fieldName,pickDateStart,pickDateEnd,userName);
        System.out.println(goods2Entities);
        Map<String,Object> map = new HashMap<>();
        //y查询贸易总金额
        ...
        List<BigDecimal> y_TotalAmount =new ArrayList<>();
        for (Goods2Entity goods2Entity : goods2Entities){
            x_TradePartnerName.add(goods2Entity.getTradePartnerName());
            y_TotalAmount.add(goods2Entity.getRmbAmount());
        }
    ...
    public Map<String,Object> areaTradeVolume(@RequestParam Map<String, Object> params){
        ...
        List<Goods2Entity> goods2Entities = goods2Service.findTotalAmountByAreaName(fieldName,pickDateStart,pickDateEnd,userName);
        System.out.println(goods2Entities);
        Map<String,Object> map = new HashMap<>();
        //y查询贸易总金额
        ...
        List<BigDecimal> y_TotalAmount =new ArrayList<>();
        for (Goods2Entity goods2Entity : goods2Entities){
            x_RegistrationPlaceName.add(goods2Entity.getRegistrationPlaceName());
            y_TotalAmount.add(goods2Entity.getRmbAmount());
        }
    ...
    /**
     * 国家贸易情况：统计14个国家，按产品金额从大到小，统计每个国家的产品贸易情况
     * @param params
     * @return
     */
...
//        System.out.println(name2);
        ...
        List<Goods2Entity> goods2Entities = goods2Service.findTotalAmountByProductNameOfNation(name,fieldName,pickDateStart,pickDateEnd,userName);
        System.out.println(goods2Entities);
        Map<String,Object> map = new HashMap<>();
        //x查询商品名字
        List<String> x_ProductName =new ArrayList<>();
    ...
    /**
     * 省市贸易情况：统计31个省市，按产品金额从大到小，**统计每个省市的产品贸易情况**。
     * @param params
     * @return
     */
    ...
    public Map<String,Object> productTradeByArea(@RequestParam Map<String, Object> params){
        ...
        List<Goods2Entity> goods2Entities = goods2Service.findTotalAmountByProductNameOfArea(area,fieldName,pickDateStart,pickDateEnd,userName);
        System.out.println(goods2Entities);
        Map<String,Object> map = new HashMap<>();
        //y查询贸易总金额
        List<String> x_ProductName =new ArrayList<>();
    ...
    public Map<String,Object> compareProductTradeByNational(@RequestParam Map<String, Object> params){
        ...
        //db
        List<Goods2Entity> goods2Entities1 = goods2Service.findTotalAmountByProductNameOfNation(national1,fieldName,pickDateStart,pickDateEnd,userName);
//        System.out.println(goods2Entities1);
        List<Goods2Entity> goods2Entities2 = goods2Service.findTotalAmountByProductNameOfNation(national2,fieldName,pickDateStart,pickDateEnd,userName);
//        System.out.println(goods2Entities2);
        //查询商品名称和贸易总额
        Result result1 = findProductNameAndTotalAmount(goods2Entities1);
        Result result2 =findProductNameAndTotalAmount(goods2Entities2);
        //合并xProductNameList
    ...
    public Map<String,Object> compareProductTradeByArea(@RequestParam Map<String, Object> params){
        ...
        Map<String,Object> returnMap = new HashMap<>();
        //db
        List<Goods2Entity> goods2Entities1 = goods2Service.findTotalAmountByProductNameOfArea(areaName1,fieldName,pickDateStart,pickDateEnd,userName);
//        System.out.println(goods2Entities1);
        List<Goods2Entity> goods2Entities2 = goods2Service.findTotalAmountByProductNameOfArea(areaName2,fieldName,pickDateStart,pickDateEnd,userName);
//        System.out.println(goods2Entities2);
        //查询商品名称和贸易总额
        Result result1 = findProductNameAndTotalAmount(goods2Entities1);
        Result result2 =findProductNameAndTotalAmount(goods2Entities2);
    ...
    /**
     * 查询贸易总金额和产品名称
     * @param goods2Entities
     * @return
     */
    public Result findProductNameAndTotalAmount(List<Goods2Entity> goods2Entities){
        List<String> xProductName =new ArrayList<>();
        List<BigDecimal> yTotalAmount =new ArrayList<>();

        List<String> x_name =new ArrayList<>();
        for (Goods2Entity goods2Entity : goods2Entities){
            xProductName.add(goods2Entity.getProductName());
            yTotalAmount.add(goods2Entity.getRmbAmount());
            x_name.add((goods2Entity.getProductNum()+"｜"+goods2Entity.getProductName()));
